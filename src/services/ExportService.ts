...
<head>
    ...
    <meta name="generator" content="EVIDENRA Basic">
    <title>${title}</title>
    <style>
        * {
            margin: 0;
...
<body>
    <div class="container">
        <div class="header">
            <div class="logo">🔬 EVIDENRA Basic</div>
            <h1>${title}</h1>
        </div>
        ...
        <div class="footer">
            <strong>Generiert mit EVIDENRA Basic</strong><br>
...
================================================================================\n\n`;
  ...
  static exportToSPSS(project: any): string {
    ...
    output += `* Generated by EVIDENRA Basic\n`;
